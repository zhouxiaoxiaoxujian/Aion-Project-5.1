...
public class ScriptManager {
	...
	public synchronized void load(File scriptDescriptor) throws Exception {
		load(new FileInputStream(scriptDescriptor));
	}

	public synchronized void load(String scriptDescriptor) throws Exception {
		load(ScriptManager.class.getResourceAsStream(scriptDescriptor));
	}

	public synchronized void load(InputStream fin) throws Exception {
