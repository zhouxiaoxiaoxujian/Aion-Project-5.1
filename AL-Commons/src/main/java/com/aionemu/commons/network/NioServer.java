...
public class NioServer {
	 ...
	 * 
	 */
	private int readWriteThreadsNumber;
	/**
	 * 
	 */
	 ...
	 */
	public NioServer(int readWriteThreadsNumber, ServerCfg... cfgs) {
		/**
		...
		this.readWriteThreadsNumber = readWriteThreadsNumber;
		this.cfgs = cfgs;
	}

	public void connect() {
		try {
			this.initDispatchers(readWriteThreadsNumber, dcPool);
	...
	/**
	 * @return one of ReadWrite Dispatcher or Accept Dispatcher if readWriteThreadsNumber was set to 0.
	 */
